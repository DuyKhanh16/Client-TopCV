        ...
        flex justify-evenly pt-[200px] bg-cover bg-center w-[100%] h-[100vh]'>
            <div className='w-[300px] h-[400px] bg-white rounded-[20px] '  >
                ...
                <ul className='m-4 ml-10' >
                    <li className='m-1'> 100.000+ Công việc mơ ước</li>
                    <li className='m-1'>365+ Mẫu CV chuyên nghiệp</li>
                    <li className='m-1'>22+ Bộ đề câu hỏi tuyển dụng</li>
                    <button onClick={() => window.location.href = '/registerUser'} className='bg-[#00B150] cursor-pointer text-white w-[200px]  h-[40px] mt-2 rounded-[5px]' >ĐĂNG KÝ ỨNG VIÊN</button>
                </ul>
            </div>
            <div className='w-[300px] h-[400px] bg-white rounded-[20px] ' >
            <img src="https://timviec365.vn/images/New_images/ntd_bg.png" alt="" />
                ...
                <button onClick={() => window.location.href = '/registerCompany'} className='bg-[#00B150] cursor-pointer text-white w-[250px]  h-[40px] ml-7 rounded-[5px]' >ĐĂNG KÝ NHÀ TUYỂN DỤNG</button>
